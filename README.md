...
> **Abstract:** Biomedical AI is currently limited by static mapping approaches that fail to capture the continuous, non-stationary nature of physiological systems. This work bridges the gap between empirical optimization instability and theory-driven design, proposing **Neural ODEs** for irregular time-series and analyzing the **"Edge of Stability" (EoS)** in safety-critical medical imaging tasks.
